...
txCharId2 = "0000ffe1-0000-1000-8000-00805f9b34fb"
rxCharId2 = "0000ffe2-0000-1000-8000-00805f9b34fb"
...
async def main():
    ...
    async with BleakClient(device) as client:
        ...
        service = client.services.get_service(serviceId2)
        print(service)

        #rxCharacteristic = service.get_characteristic(normalize_uuid_16(rxCharId))
        rxCharacteristic = service.get_characteristic(rxCharId2)
        ...
        txCharacteristic = service.get_characteristic(txCharId2)
